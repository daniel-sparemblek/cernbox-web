...
--
-- Host: 127.0.0.1    Database: cernboxngcopy
-- ------------------------------------------------------
...
CREATE TABLE `cbox_metadata` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11589 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `cbox_notification_recipients`
--

DROP TABLE IF EXISTS `cbox_notification_recipients`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cbox_notification_recipients` (
  ...
  PRIMARY KEY (`id`),
  KEY `cbox_notification_recipients_ix0` (`notification_id`),
  KEY `cbox_notification_recipients_ix1` (`recipient`),
  CONSTRAINT `cbox_notification_recipients_ibfk_1` FOREIGN KEY (`notification_id`) REFERENCES `cbox_notifications` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=195 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `cbox_notifications`
--

DROP TABLE IF EXISTS `cbox_notifications`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cbox_notifications` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ref` varchar(3072) DEFAULT NULL,
  `template_name` varchar(320) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ref` (`ref`),
  KEY `cbox_notifications_ix0` (`ref`)
...
) ENGINE=InnoDB AUTO_INCREMENT=1116203 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=334190 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-13 14:23:43
